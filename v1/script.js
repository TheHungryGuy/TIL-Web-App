...
//const fs = require("fs");
let SUPABASE_API_KEY = fs.readFileSync("./SUPABASE_API_KEY");
const initialFacts = [
  {
    id: 1,
...
async function loadfacts() {
  const res = await fetch(
    "https://ufwnbehbplcbanpwsixk.supabase.co/rest/v1/facts",
    {
      headers: {
...
function createFactsList(dataArray) {
  //factList.insertAdjacentHTML("afterbegin", "<li> Antonio</li>");
...
console.log(newFact);
const factObj = {
  text: "Lisbon is the captial of Portugal",
  category: "society",
  createdIn: 2015,
  isCorrect: true,
